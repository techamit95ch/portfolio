export const resumeData = {
  personalInfo: {
    ...
    summary:
      "Seasoned React Native Developer with 4+ years' experience, 13 apps released, and deep expertise in backend Node JS and PHP. Expert in UI/UX and mentoring.",
  ...
  professionalExperience: [
    {
      ...
      projects: [
        ...
        },
        {
          ...
          duration: "4 months",
          description:
            "Sports betting application with real-time odds and live streaming.",
          image:
        ...
        },
        {
          ...
          duration: "3 months",
          description: "Smart home automation app with IoT device integration.",
          image:
      ...
      projects: [
        {
          ...
          role: "Full-stack development across multiple platforms.",
        },
        {
          name: "Government Projects",
          description:
            "Successfully secured and restructured 13 government projects.",
          role: "Backend development and security implementation.",
        },
        {
          name: "Proprietary PHP Framework",
          description:
            "Developed a proprietary PHP framework and AngularJS components.",
          role: "Lead developer for framework architecture and implementation.",
        },
        {
          name: "Hotel Websites",
          description:
            "Worked on backend development and integration for small hotel websites.",
          role: "Backend developer and system integrator.",
        },
      ],
    },
    {
  ...
  education: [
    {
      ...
      projects: [
        ...
        {
          type: "Minor",
          description: "MERN Stack note distribution and viewing app.",
        },
      ],
    },
    {
      ...
      projects: [
        {
          type: "Major",
          description: "Matlab-based traffic signal data clustering.",
        },
        {
          type: "Minor",
          description:
            "C++ analysis and clustering with Bayesian Methods and Fuzzy Logic using Facebook data.",
        },
      ],
    },
    {
  ...
  skills: {
    ...
    uiFrameworks: ["MUI", "ChakraUI", "Tailwind CSS"],
    tools: ["GitHub", "Jira", "Slack"],
    foundationalUnderstanding: ["Nest.js", "Ether.js", "WEB3.1", "MetaMask"],
    priorExperience: ["PHP/MySQL", "Codeigniter", "Django"],
    ...
    frameworks: [
      { name: "gatsby", status: "currently using" },
      { name: "next js", status: "currently using" },
      { name: "create react app", status: "currently using" },
      { name: "express", status: "currently using" },
      { name: "django", status: "currently using" },
      { name: "flask", status: "last used 1 year ago" },
      { name: "laravel", status: "last used 3 year ago" },
      { name: "codeignator", status: "last used 3 year ago" },
    ],
    databases: [
      { name: "MySQL", rating: 4 },
      { name: "MongoDB", rating: 3 },
      { name: "PL/SQL", rating: 2 },
    ],
    otherTechnologies: [
      "Git",
      "AWS",
  ...
  strengths: [
    {
      ...
      description:
        "Applied strategic thinking to handle complex app design performance and user experience challenges resulting in efficient solutions in every project.",
    },
    {
      name: "Detail Oriented",
      description:
        "Focus on minutest details has contributed to my crafting of interactive user interfaces resulting in positive user experiment.",
    },
    {
      name: "Continuous Learner",
      description:
        "Committed to staying updated with new technologies Solidity, Rust and a passion for exploring innovative solutions.",
    },
    {
      name: "Leadership and Mentorship",
      description:
        "Provided mentorship in multiple projects, fostering teamwork and guiding new developers in native technology.",
    },
  ],
  achievements: [
  ...
  achievements2: [
    {
      ...
      description:
        "Developed and launched 13 mobile applications, including 7 iOS and 6 Android apps, demonstrating expertise in cross-platform development.",
    },
    {
      title: "Blockchain Integration Pioneer",
      description:
        "Successfully integrated blockchain technology into sports and finance applications, enhancing security and user experience.",
    },
    {
      title: "Mentorship and Team Leadership",
      description:
        "Mentored junior developers, significantly improving team productivity and code quality.",
    },
    {
      title: "Government Project Delivery",
      description:
        "Successfully delivered 13 secure government projects, improving functionality and security in critical systems.",
    },
    {
      title: "Performance Optimization",
      description:
        "Increased efficiency by 40% through the development of a GST App and implementation of REST APIs.",
    },
  ],
  languages: [
    { name: "Bengali", proficiency: "Native" },
    { name: "English", proficiency: "Professional, Moderate" },
    { name: "Hindi", proficiency: "Moderate" },
  ],
  interests: [
    "Programming",
    "Reading",
  ...
  certifications: [
    ...
    { name: "Near Blockchain", provider: "Udemy", status: "In Progress" },
    {
    ...
    { name: "PHP", provider: "Webskitters", date: "Jul 2017 - Present" },
    {
  ...
  freelanceProjects: [
    {
      name: "Be4You",
      description:
        "It's dating App For a client, MVP  for inital funding. Custom animation, coctet ios, social login, apple loging, zoom type video call fature, live location, maps etc.",
      link: "comming soon",
    },
  ],
  additionalProjects: [
    {
      name: "Next js My cutom starter",
      description:
        "Was making t3 based, Blockchanin integrations  oriented  custom next js template. I  use special  work ethics for this kind of roles",
      github: "https://github.com/techamit95ch/nextjs-wagmi-starter",
    },
    {
      name: "We are Here",
      description:
        "Swiping animtions based ating... Here I ahave done custom animation. Scocket technology, Video call feature. My own cutom animation feature",
      github: "https://github.com/techamit95ch/we-fo-you",
    },
    {
      name: "React native template",
      description: "New architecture based react native template I am making",
    ...
    {
      name: "Assembly script Based Project",
      description:
        "Near block chain based app, based on assembly script, it's similar like type script",
      github: "https://github.com/techamit95ch/near-courses-assembly",
    },
    {
      name: "Vite near App",
      description:
        "Near block chain based app, based on assembly script, it's in type script",
      github:
        "https://github.com/techamit95ch/near-dapp-vite-courses-marketplace",
    },
    {
    ...
    {
      name: "College and Student Chart",
      description:
        "Chart system using React, Redux, NodeJS (Faker), Ant Design + Material Design",
      url: "https://collegestudentchart.herokuapp.com",
    ...
    {
      name: "Ecommerce",
      description: "Ecommerce platform built with Django",
    ...
    },
    {
      ...
      description: "Restaurant app similar to Uber Eats",
